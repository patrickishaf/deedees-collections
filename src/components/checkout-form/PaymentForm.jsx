...
const stripePromise = loadStripe('pk_test_29403d2d3105a29df38842313c5443279054601a2f087');

const PaymentForm = ({ checkoutToken, shippingData, previousStep, onCaptureCheckout, nextStep }) => {
